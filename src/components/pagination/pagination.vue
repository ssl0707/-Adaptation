    ...
    export default {
        ...
        computed: {
            ...
            groupList () {
                ...
                groupArray[0] = 1
                groupArray[groupArray.length - 1] = totalPage
                if (offset.end < totalPage) {
                    groupArray.splice(groupArray.length - 1, 0, '…')
                }
                if (groupArray[1] - groupArray[0] > 1) {
                    groupArray.splice(1, 0, '…')
                }
                totalPage <= 9 ? this.showSideBtn = false : this.showSideBtn = true;
